...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:medium:size=12" };
static const char dmenufont[]       = "JetBrainsMono Nerd Font:medium:size=12";
...
static const char polar_night1[]    = "#2E3440";
static const char polar_night2[]    = "#3B4252";
static const char polar_night3[]    = "#434C5E";
static const char polar_night4[]    = "#4C566A";
...
static const char *colors[][3]      = {
	...
	// [SchemeSel]  = { snow_storm3, frost4, frost2 }
	[SchemeSel]  = { polar_night1, frost3, frost2 }
};
